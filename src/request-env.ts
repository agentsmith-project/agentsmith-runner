const SCRUBBED_CHILD_ENV_KEYS = new Set([
  ...
  'MBOS_AGENT_TASK_RUNNER_REQUIRE_BWRAP',
  'MBOS_AGENT_ARTIFACT_SCAN_MAX_FILES',
  'MBOS_AGENT_ARTIFACT_SCAN_MAX_FILE_BYTES',
  'MBOS_AGENT_ARTIFACT_INLINE_IMAGE_MAX_BYTES',
  'MBOS_AGENT_ARTIFACT_TEXT_PREVIEW_MAX_BYTES',
  'MBOS_AGENT_WORKSPACE_FILE_SCAN_MAX_FILES',
  'MBOS_AGENT_WORKSPACE_FILE_CHANGE_LIST_MAX',
  'MBOS_AGENT_TASK_ASSET_IO_TIMEOUT_MS',
