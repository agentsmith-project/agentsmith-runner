...
check_runner_image_publish_focused_evidence() {
  ...
  require_grep "Focused publish evidence only.*runner-release-manifest.*runner-ga-handoff" "$workflow" "runner image publish labels manifest and handoff artifacts as focused evidence"
  ...
  require_grep "digest-pinned GHCR image.*runner-release-manifest.*runner-ga-handoff" README.md "README describes publish evidence output including handoff artifact"
  require_grep "downstream AgentSmith lock/release-contract adoption and release-kit final aggregation" README.md "README ties runner publish artifacts to downstream GA adoption and aggregation"
  ...
  require_grep "manual focused GHCR publish evidence.*runner release manifest artifact.*runner GA handoff artifact" docs/adr/0001-bootstrap-boundary.md "ADR documents focused publish evidence allowance"
  require_grep "downstream inputs for AgentSmith lock/release-contract adoption and release-kit final aggregation" docs/adr/0001-bootstrap-boundary.md "ADR ties runner artifacts to downstream GA chain"
